...
const HearingSpeechAid = () => {
  ...
  return (
    <div className="container">
      <h1 className="title">Hearing and Speech AID Application</h1>
      ...
      <div className="record-section">
        ...
        {patientRecords.map((record, index) => (
          <div key={index}>
            ...
            <p>
              Timestamp:
              {new Date(record.timestamp.toNumber() * 100).toLocaleDateString}
            </p>
          </div>
        ))}
      </div>
...
export default HearingSpeechAid;
